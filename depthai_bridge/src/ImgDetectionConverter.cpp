...
#endif
std::cout << "ImgDetectionConverter::ImgDetectionConverter" << std::endl;
...
void ImgDetectionConverter::toRosMsg(std::shared_ptr<dai::ImgDetections> inNetData, std::deque<VisionMsgs::Detection2DArray>& opDetectionMsgs) {
    // setting the header
    std::cout << "ImgDetectionConverter::toRosMsg" << std::endl;
//    if(inNetData == NULL){
//      std::cout << "ImgDetectionConverter::toRosMsg: inNetData = NULL" << std::endl;
//      return;
//    }
    #if 1
